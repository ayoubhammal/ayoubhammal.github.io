...
const Curriculum: Component = () => {
    return (
        <main class="main">
            <h1>Ayoub Hammal</h1>
            <hr/>
            Computer Science/Artificial Intelligence student, looking for PhD opportunities.
            <section>
                ...
                <ul>
                    <li>
                        <div class={styles["item-title"]}>
                            <span>Master 1 in Artificial Intelligence</span> <span>2022 - to this day</span>
                        </div>
                        <div class={styles["item-description"]}>
                            Paris-Saclay University. Valedictorian, Excellence honors.
                        </div>
                    </li>

                    <li>
                        <div class={styles["item-title"]}>
                            <span>Master 1 in Intelligent Computer Systems</span> <span>2021 - 2022</span>
                        </div>
                        <div class={styles["item-description"]}>
                            USTHB, Algiers. Valedictorian, Very Good honors.
                        </div>
                    </li>

                    <li>
                        <div class={styles["item-title"]}>
                            <span>Bachelor’s degree in Computer Science</span> <span>2018 - 2021</span>
                        </div>
                        <div class={styles["item-description"]}>
                            USTHB, Algiers. Valedictorian, Excellence honors.
                        </div>
                    </li>
            ...
            <section>
                <h2 id="projects">Academic Experience</h2>
                <hr/>
                <ul>
                    <li>
                        <div class={styles["item-title"]}>
                            <span><b>Research Internship at ISIR, Sorbonne, Paris</b>: <em>Supervised and semi-supervised sequence-to-sequence models for structured prediction.</em></span> <span><em>2024</em></span>
                        </div>
                        <div class={styles["item-description"]}>
                            <em>Supervised and semi-supervised sequence-to-sequence models for structured prediction.</em>
                            <ul>
                                <li>Development of locally and globally normalized models for named-entity recognition task.</li>
                            </ul>
                        </div>
                    </li>
                    <li>
                        <div class={styles["item-title"]}>
                            <span><b>Research Work</b>: <em>Literature review on the mechanism of attention</em></span> <span><em>2023</em></span>
                        </div>
                        <div class={styles["item-description"]}>
                            <em>Survey paper soon to be submitted for publication.</em> I was interested mainly in:
                            <ul>
                                <li>The different approaches in the literature for modeling the soft/hard argmax operators intervening on the attention scores.</li>
                                <li>The different probing and analysis methods of trained attention-based networks, including its explainability and the linguistic features they entailed.</li>
                            </ul>
                        </div>
                    </li>
                    <li>
